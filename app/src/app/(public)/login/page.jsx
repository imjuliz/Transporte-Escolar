          ...
          <div className="login-corpo">
            ...
            <form id='loginForm' onSubmit={limparForm}>
              ...
              <div className='campo-senha'>
                <input type={senhaVisivel ? "text" : "password"} id="senha" placeholder="Digite sua senha" onChange={event => { setSenha(event.target.value) }} />
              ...
              <button type="submit" className='btn-entrar' onClick={login}>Entrar</button>
