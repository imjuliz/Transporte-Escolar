...
export default function aluno() {
    ...
    const iconsNav =
    {
        ...
        viagens: (
            ...
            <mask id="mask0_95_759" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
            <path d="M0 0.123444H19.9706V19.9853H0V0.123444Z" fill="white"/></mask>
            <g mask="url(#mask0_95_759)"><path d="M16.814 11.5275C16.814 11.9003 16.5868 12.2311 16.2505 12.3495C14.6453 12.9101 12.4248 13.2569 9.97363 13.2569C7.52341 13.2569 5.3031 12.9101 3.69678 12.3495C3.36134 12.2311 3.1335 11.9003 3.1335 11.5275V4.32628C3.1335 3.88984 3.46986 3.53635 3.88584 3.53635H16.0623C16.4783 3.53635 16.814 3.88984 16.814 4.32628V11.5275ZM16.814 14.9973C16.814 15.877 16.0219 16.5907 15.0459 16.5907H12.8384C12.3229 16.5907 12.1577 15.965 12.6189 15.7562L16.13 14.1686C16.4439 14.0266 16.814 14.2322 16.814 14.5493V14.9973ZM7.10881 16.5907H4.90158C3.9253 16.5907 3.1335 15.877 3.1335 14.9973V14.5493C3.1335 14.2322 3.50359 14.0266 3.81747 14.1686L7.32862 15.7562C7.78957 15.965 7.6246 16.5907 7.10881 16.5907ZM6.35234 1.36211C6.35234 1.2319 6.45307 1.12701 6.57605 1.12701H13.3721C13.4953 1.12701 13.5949 1.2319 13.5949 1.36211V2.49878C13.5949 2.62899 13.4953 2.73388 13.3721 2.73388H6.57605C6.45307 2.73388 6.35234 2.62899 6.35234 2.49878V1.36211ZM19.5937 5.14321H19.3828V4.94477C19.3828 4.57271 19.0949 4.27009 18.7406 4.27009H17.947V2.33964C17.947 2.08597 17.894 1.84484 17.8006 1.62759C17.5831 1.12002 17.1253 0.775206 16.6063 0.666941C16.5097 0.646445 16.4134 0.627155 16.3175 0.608588C13.253 0.0156577 9.97363 0.14249 9.97363 0.14249C9.97363 0.14249 6.69444 0.0156577 3.6307 0.608588C3.53433 0.627155 3.43843 0.646445 3.34183 0.666941C2.82284 0.775206 2.36487 1.12002 2.1469 1.62759C2.05443 1.84484 2.0012 2.08597 2.0012 2.33964V4.27009H1.20756C0.853534 4.27009 0.565585 4.57271 0.565585 4.94477V5.14321H0.354728C0.159931 5.14321 0.0020752 5.30887 0.0020752 5.51358V8.41024C0.0020752 8.61471 0.159931 8.78061 0.354728 8.78061H1.25919C1.45375 8.78061 1.61161 8.61471 1.61161 8.41024V5.51358C1.61161 5.30887 1.45375 5.14321 1.25919 5.14321H1.04833V4.94477C1.04833 4.85266 1.11969 4.77767 1.20756 4.77767H2.0012V15.9997C2.0012 16.9068 2.51424 17.6871 3.25143 18.0399V19.543C3.25143 19.788 3.44026 19.9862 3.67338 19.9862H5.86707C6.09996 19.9862 6.28879 19.788 6.28879 19.543V18.2407H13.6594V19.543C13.6594 19.788 13.8482 19.9862 14.0813 19.9862H16.275C16.5079 19.9862 16.6967 19.788 16.6967 19.543V18.0399C17.4339 17.6871 17.947 16.9068 17.947 15.9997V4.77767H18.7406C18.8285 4.77767 18.8998 4.85266 18.8998 4.94477V5.14321H18.6892C18.4944 5.14321 18.3366 5.30887 18.3366 5.51358V8.41024C18.3366 8.61471 18.4944 8.78061 18.6892 8.78061H19.5937C19.7885 8.78061 19.9461 8.61471 19.9461 8.41024V5.51358C19.9461 5.30887 19.7885 5.14321 19.5937 5.14321Z" fill="white" fillOpacity="0.5"/>
            </g></g><defs><clipPath id="clip0_95_759"><rect width="20" height="20" fill="white"/> </clipPath></defs> </svg>
            ),
        motoristas: (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <header>
                <div className="sidebar">
                    <div className="logoContent">
                        <div className="logo">
                            <div className="logoName">Aluno</div>
