...
{/*MOTORISTA NOME, EMAIL E TELEFONE*/}
                <div className='sec'>
                    <div className='sec-indicador'>
                        <h4>Dados pessoais do motorista</h4>
                        <hr />
                    </div>
                    <div className='sec-container flex flex-row flex-wrap gap-3 justify-between'>
                        ...
                        <div className='sec-campos'>
                            <h6>Telefone:</h6>
                            <p>{formatarTelefone(motorista.telefone)}</p>
                        </div>
                    </div>
                </div>
{/*VEICULO - MODELO, PLACA, ANO DE FABRICAÇÃO E CAPACIDADE*/}
                <div className='sec flex flex-col gap-3'>
                    <div className='sec-indicador'>
                        <h4>Dados do veículo</h4>
                        <hr />
                    </div>
                    <div className='sec-container flex flex-row flex-wrap gap-8 justify-between'>
                        <div className='sec-campos'>
                            <h6>Modelo:</h6>
                            <p>{veiculo.modelo}</p>
                        </div>
