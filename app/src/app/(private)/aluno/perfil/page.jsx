...
/> */}
            ...
            <div className='sec'>
                ...
                <div className='sec-container flex flex-col gap-8'>
                    <div className='sec-campos'><h6>Email pessoal:</h6><p>{usuario.emailPessoal || usuario.email || "-"}</p></div>
                    <div className='sec-campos flex gap-10'>
                        <div className='sec-campos2'><h6>Telefone:</h6><p>{usuario.telefonePrinc || usuario.telefone || "-"}</p></div>
