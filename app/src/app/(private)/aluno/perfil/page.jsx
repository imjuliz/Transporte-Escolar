...
//                 const formData = {};
//                 if (telefoneSemMascara) formData.telefonePrinc = telefoneSemMascara;
...
//                         <div className='sec-campos2'><h6>Telefone:</h6><p>{formatarTelefone(usuario.telefonePrinc)}</p></div>
