        ...
        return (
          <>
            <div className="relative z-0 w-full mb-5 group">
              <input name="cpf"   id="cpf" ref={cpfInputRef} maxLength='14' onChange={handleChange} className="input block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none peer" placeholder="000.000.000-00" required  />
